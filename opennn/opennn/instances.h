...
public:  
   ...
   Vector< Vector<size_t> > get_training_batchs_indices(const size_t&) const;
   Vector< Vector<size_t> > get_selection_batchs_indices(const size_t&) const;
   Vector< Vector<size_t> > get_testing_batchs_indices(const size_t&) const;
