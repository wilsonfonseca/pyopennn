...
Matrix<double> OutputsTrendingLayer::get_Jacobian(const Vector<double>& derivatives) const
{
   const size_t outputs_trending_neurons_number = get_outputs_trending_neurons_number();
...
Vector< Matrix<double> > OutputsTrendingLayer::get_Hessian(const Vector<double>&) const
{
   const size_t outputs_trending_neurons_number = get_outputs_trending_neurons_number();
