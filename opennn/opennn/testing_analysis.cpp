...
Vector< Matrix<double> > TestingAnalysis::calculate_target_output_data() const
{
   ...
   const Matrix<double> testing_input_data = data_set_pointer->get_testing_input_data();
...
Vector< Matrix<double> > TestingAnalysis::calculate_forecasting_target_output_data() const
{
   ...
   const Matrix<double> target_data = data_set_pointer->get_testing_target_data();
...
Vector< LinearRegressionParameters<double> > TestingAnalysis::calculate_linear_regression_parameters() const
{
   ...
   const Matrix<double> input_data = data_set_pointer->get_testing_input_data();
   const Matrix<double> target_data = data_set_pointer->get_testing_target_data();
...
Vector<double> TestingAnalysis::calculate_training_errors() const
{
    ...
    const Matrix<double> input_data = data_set_pointer->get_training_input_data();

    const Matrix<double> target_data = data_set_pointer->get_training_target_data();
