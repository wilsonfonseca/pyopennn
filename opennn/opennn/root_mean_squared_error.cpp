...
Matrix<double> RootMeanSquaredError::calculate_output_Hessian(const Vector<size_t>&, const Vector<double>& output, const Vector<double>& target) const
{
/*
    ...
    const double loss = calculate_training_error();
