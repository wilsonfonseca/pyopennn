...
Matrix<double> Matrix<T>::calculate_linear_combinations(const Matrix<double>& other_matrix, const Vector<double>& other_vector) const
{
   ...
   for(size_t i = 0; i < rows_number; i++)
   {
     for(size_t j = 0; j < other_columns_number; j++)
     {
       for(size_t k = 0; k < columns_number; k++)
       {
            new_matrix(i,j) += (*this)(i,k)*other_matrix(k,j);
       }

       new_matrix(i,j) += other_vector[j];
     }
   }
...
template<class T>
Matrix<T> hyperbolic_tangent_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> linear_second_derivative(const Matrix<T>& x)
{
...
template<class T>
Matrix<T> hyperbolic_tangent_second_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> logistic_derivative(const Matrix<T>& x)
{
     Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> logistic_second_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> threshold_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> threshold_second_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> symmetric_threshold_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
...
template<class T>
Matrix<T> symmetric_threshold_second_derivative(const Matrix<T>& x)
{
    Matrix<T> y(x.get_rows_number(), x.get_columns_number());
