...
/// @param input_data Matrix of inputs to the KNN.
...
Matrix<double> KNearestNeighbors::calculate_output_data(const Matrix<double>& input_data) const
{
    ...
    Matrix<double> output_data(instances_number, targets_number);
...
Matrix<double> KNearestNeighbors::calculate_selection_output_data(void) const
{
    return calculate_output_data(data_set_pointer->get_selection_input_data());
}
...
Matrix<double> KNearestNeighbors::calculate_testing_output_data(void) const
{
    return calculate_output_data(data_set_pointer->get_testing_input_data());
}
...
{
    const Matrix<double> training_inputs = data_set_pointer->get_training_input_data();
...
{
    const Matrix<double> targets = data_set_pointer->get_training_target_data();
...
{
    const Matrix<double> testing_target_data = data_set_pointer->get_testing_target_data();

    const Matrix<double> testing_output_data = calculate_testing_output_data();

    Vector< Statistics<double> > testing_error = calculate_error_statistics(testing_target_data,testing_output_data);
...
{
    const Matrix<double> selection_target_data = data_set_pointer->get_selection_target_data();

    const Matrix<double> selection_output_data = calculate_selection_output_data();

    Vector< Statistics<double> > selection_error = calculate_error_statistics(selection_target_data,selection_output_data);
...
/// The format is a vector, where each element contains the error statistics associated to each target.
/// @param target_data is the matrix of targets.
/// @param output_data is the matrix of outputs.

Vector< Statistics<double> > KNearestNeighbors::calculate_error_statistics(const Matrix<double>& target_data,
                                                                           const Matrix<double>& output_data) const
{
    TestingAnalysis testing_analysis(data_set_pointer);

    Vector< Statistics<double> > error_statistics = testing_analysis.calculate_percentage_errors_statistics(target_data,
                                                                                                           output_data);
