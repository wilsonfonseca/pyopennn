...
Matrix<double> InputsTrendingLayer::get_Jacobian(const Vector<double>& derivatives) const
{
   const size_t inputs_trending_neurons_number = get_inputs_trending_neurons_number();
...
Vector< Matrix<double> > InputsTrendingLayer::get_Hessian(const Vector<double>&) const
{
   const size_t inputs_trending_neurons_number = get_inputs_trending_neurons_number();
