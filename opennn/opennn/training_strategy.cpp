...
void TrainingStrategy::set_MPI(LossIndex* new_loss_index, const TrainingStrategy* training_strategy)
{
    ...
    switch(original_training_method)
    {
        case(int)TrainingStrategy::GRADIENT_DESCENT:
            ...
            gradient_descent_pointer->set_maximum_selection_error_increases(maximum_selection_loss_increases);
        ...
        case(int)TrainingStrategy::CONJUGATE_GRADIENT:
            ...
            conjugate_gradient_pointer->set_maximum_selection_error_increases(maximum_selection_loss_increases);
        ...
        case(int)TrainingStrategy::QUASI_NEWTON_METHOD:
            ...
            quasi_Newton_method_pointer->set_maximum_selection_error_increases(maximum_selection_loss_increases);
        ...
        case(int)TrainingStrategy::LEVENBERG_MARQUARDT_ALGORITHM:
            ...
            Levenberg_Marquardt_algorithm_pointer->set_maximum_selection_error_increases(maximum_selection_loss_increases);
