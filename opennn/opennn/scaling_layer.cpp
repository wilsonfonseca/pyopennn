...
Matrix<double> ScalingLayer::get_Jacobian(const Vector<double>& derivatives) const
{
    const size_t scaling_neurons_number = get_scaling_neurons_number();
...
Vector< Matrix<double> > ScalingLayer::get_Hessian(const Vector<double>& second_derivative) const
{
    const size_t scaling_neurons_number = get_scaling_neurons_number();
