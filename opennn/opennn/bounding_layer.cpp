...
// Matrix<double> get_Jacobian(const Vector<double>&) const method
...
Matrix<double> BoundingLayer::get_Jacobian(const Vector<double>& derivatives) const
{   
   const size_t bounding_neurons_number = get_bounding_neurons_number();
   ...
   if(derivatives_size != bounding_neurons_number) 
   {
      ...
      buffer << "OpenNN Exception: BoundingLayer class.\n"
             << "Matrix<double> get_Jacobian(const Vector<double>&) method.\n"
...
// Vector< Matrix<double> > get_Hessian(const Vector<double>&) const method
...
Vector< Matrix<double> > BoundingLayer::get_Hessian(const Vector<double>&) const
{
   const size_t bounding_neurons_number = get_bounding_neurons_number();
