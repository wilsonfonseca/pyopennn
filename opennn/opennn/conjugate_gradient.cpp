...
const size_t& ConjugateGradient::get_maximum_iterations_number() const
{
...
const bool& ConjugateGradient::get_reserve_loss_history() const
{
...
{
   maximum_selection_loss_decreases = new_maximum_selection_error_increases;
}
...
//         training_loss = directional_point[1];
      ...
      gradient = loss_index_pointer->calculate_loss_gradient(training_batch_indices);
      ...
      selection_error = loss_index_pointer->calculate_error(selection_batch_indices);
      ...
      else if(iteration != 0 && selection_error > old_selection_error)
      {
         selection_failures++;
      }
      ...
      if(iteration != 0 && training_rate < numeric_limits<double>::min())
      {
         // Reset training direction
...
//         if(display)
//         {
//            cout << "Iteration " << iteration << ": Minimum loss decrease reached.\n";
//            cout << "Loss decrease: " << loss_decrease << endl;
//         }
