...
public:
   ...
   Vector< Matrix<double> > calculate_combinations_Hessian(const Vector<double>&) const;
   ...
   Vector<double> calculate_combinations(const Vector<double>&, const Vector<double>&, const Matrix<double>&) const;


   Matrix<double> calculate_combinations_parameters_Jacobian(const Vector<double>&) const;
   ...
   Matrix<double> get_activations_Jacobian(const Vector<double>&) const;
   Vector< Matrix<double> > get_activations_Hessian(const Vector<double>&) const;
   ...
   Vector<double> calculate_outputs(const Vector<double>&, const Vector<double>&, const Matrix<double>&) const;
   Matrix<double> calculate_Jacobian(const Vector<double>&, const Vector<double>&, const Matrix<double>&) const;
   Vector< Matrix<double> > calculate_Hessian(const Vector<double>&, const Vector<double>&, const Matrix<double>&) const;
