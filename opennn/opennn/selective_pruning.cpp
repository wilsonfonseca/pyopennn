...
SelectivePruning::SelectivePruningResults* SelectivePruning::perform_inputs_selection()
{
    ...
    while(!end)
    {
        ...
        for(size_t i = 0; i < current_inputs_number; i++)
        {
            ...
            error_ratios[i+index] = loss_index_pointer->calculate_error(selection_indices);
        ...
        current_training_loss = loss_index_pointer->calculate_loss(training_indices);
        current_selection_loss = loss_index_pointer->calculate_error(selection_indices);
    ...
    optimum_loss_error = loss_index_pointer->calculate_loss(training_indices);
    optimum_selection_error = loss_index_pointer->calculate_error(selection_indices);
    ...
    results->final_selection_error = current_selection_loss;
