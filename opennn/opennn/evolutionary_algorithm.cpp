...
void EvolutionaryAlgorithm::set_maximum_selection_error_increases(const size_t& new_maximum_selection_loss_decreases)
{
...
//   double old_selection_loss = 0.0;
   ...
   for(size_t generation = 0; generation <= maximum_generations_number; generation++)
   {
     ...
     if(best_generation_loss < best_loss_ever)
     {
      ...
      {
         results_pointer->selection_error_history[generation] = selection_loss;
      }
