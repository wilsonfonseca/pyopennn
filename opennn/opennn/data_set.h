...
public:
   ...
   Matrix<double> get_input_data(const Vector<size_t>&) const;
   Matrix<double> get_target_data(const Vector<size_t>&) const;

   Matrix<double> get_used_data() const;
   Matrix<double> get_used_input_data() const;
   Matrix<double> get_used_target_data() const;

   Matrix<double> get_training_input_data() const;
   Matrix<double> get_training_target_data() const;
   Matrix<double> get_selection_input_data() const;
   Matrix<double> get_selection_target_data() const;
   Matrix<double> get_testing_input_data() const;
   Matrix<double> get_testing_target_data() const;
