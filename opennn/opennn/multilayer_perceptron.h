...
//               biases[i] = parameters.get_subvector(position + layer_parameters_number - perceptrons_number, position + layer_parameters_number-1);
   ...
   //LayersParameters get_layers_parameters(const Vector<double>&) const;
   ...
   Vector<double> calculate_outputs_layer_combinations(const size_t&, const Vector<double>&) const;
   Matrix<double> calculate_outputs_layer_combinations(const size_t&, const Matrix<double>&) const;

   Vector< Matrix<double> > calculate_layers_delta(const Vector< Vector<double> >&) const;
...
//   Vector< Matrix<double> > calculate_output_layers_delta(const Vector< Vector<double> >&, const Vector<double>&, const Vector<double>&) const;
   ...
   Vector< Vector<double> > get_layers_input(const Vector<double>&, const Vector< Vector<double> >&) const;
   Vector< Vector<double> > get_layers_input(const Vector<double>&, const Vector< Vector< Vector<double> > >&) const;

   // Forward propagation combination

   Vector< Vector<double> > calculate_layers_combinations(const Vector<double>&) const;
   Vector< Matrix<double> > calculate_layers_combinations(const Matrix<double>&) const;
   Vector< Matrix<double> > calculate_layers_combinations_Jacobian(const Vector<double>&) const;
   ...
   Vector< Vector<double> > calculate_layers_activations(const Vector<double>&) const;
   Vector< Vector<double> > calculate_layers_activations_derivatives(const Vector<double>&) const;
   ...
   Vector< Vector< Matrix<double> > > calculate_layers_Hessian(const Vector<double>&) const;
   ...
   Vector< Matrix<double> > calculate_Hessian(const Vector<double>&, const Vector<double>&) const;
