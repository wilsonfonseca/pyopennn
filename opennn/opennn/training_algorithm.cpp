...
void TrainingAlgorithm::set_training_maximum_batch_size(const size_t& new_maximum_batch_size)
{
    training_maximum_batch_size = new_maximum_batch_size;
}

void TrainingAlgorithm::set_training_minimum_batch_size(const size_t& new_minimum_batch_size)
{
    training_minimum_batch_size = new_minimum_batch_size;
}

void TrainingAlgorithm::set_training_initial_batch_size(const size_t& new_training_initial_batch_size)
{
    training_initial_batch_size = new_training_initial_batch_size;
}

void TrainingAlgorithm::set_training_factor_batch_size(const double& new_factor_batch_size)
{
    training_factor_batch_size = new_factor_batch_size;
}

void TrainingAlgorithm::set_epochs_number(const size_t& new_epochs_number)
{
    epochs_number = new_epochs_number;
}
