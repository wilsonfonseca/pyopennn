...
Matrix<double> UnscalingLayer::get_Jacobian(const Vector<double>& derivatives) const
{
    const size_t unscaling_neurons_number = get_unscaling_neurons_number();
...
Vector< Matrix<double> > UnscalingLayer::get_Hessian(const Vector<double>& second_derivative) const
{
    const size_t unscaling_neurons_number = get_unscaling_neurons_number();
